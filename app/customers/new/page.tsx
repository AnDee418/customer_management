        ...
        <div className="page-header">
          <div className="header-title-group">
            ...
            <div className="title-wrapper">
              <h1 className="page-title">新規顧客登録</h1>
              <p className="page-description">顧客情報を入力してください</p>
            </div>
          </div>
        </div>
            ...
            <div className="form-group">
              ...
              <div className="input-info">
                <span className="info-badge">
                  <FontAwesomeIcon icon={faTimes} style={{ fontSize: '0.75rem', marginRight: '0.25rem' }} />
                  自動生成
                </span>
                <p className="info-text">登録時に自動的に採番されます（例: CUST-20251021-0001）</p>
              </div>
            </div>
